...
Verdict: WARN
diff_fingerprint: cb12abeaddabf3c8
reviewed_diff: cb12abeaddabf3c8
...
The source workspace commit-only fingerprint was `0099fa09db1064ed`.
`cb12abeaddabf3c8` is the isolated publication fingerprint rebased onto
`xunji-harness/main`; the source workspace's other staged paths and private
artifacts remain outside this publication branch.
