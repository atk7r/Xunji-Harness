...
- `knowledge/README.md` for the public grounding tier vs local weaponized tier.
...
- Keep payloads, exploit chains, request bodies, and PoCs out of public
...
Seed a public grounding entry when a product is clearly fingerprinted but no
...
- Leave payloads and request bodies in the local weaponized tier, not public
  grounding files.
