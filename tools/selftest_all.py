...
SUITES: list[tuple[str, list[str], str]] = [
    ...
    ("subagent_stop_ingress", ["tools/harness/subagent_stop_ingress.py", "--selftest"],
     "schema-independent SubagentStop arrival capture"),
    ...
    ("fetch_assets",   ["tools/fetch_assets.py", "--selftest"],   "SPA asset output placement"),
    ...
    ("output_layout",  ["tools/harness/output_layout.py", "--selftest"], "canonical run/tmp output placement"),
    ("artifact_view",  ["tools/artifact_view.py", "--selftest"], "bounded read-only run artifact inspection"),
    ...
    ("check_rules",     ["tools/check_rules.py"],                    "architecture + safety manifest drift guard"),
    ...
    ("completion_transaction", ["tools/completion_transaction.py", "--selftest"], "atomic closure prepare/commit/reopen transaction"),
    ("barrier_state",   ["tools/barrier_state.py", "--selftest"], "repeated zero-byte infrastructure failure barrier"),
    ("work_plan",       ["tools/work_plan.py", "--selftest"], "versioned work-plan + delegation contract"),
