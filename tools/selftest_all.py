...
SUITES: list[tuple[str, list[str], str]] = [
    ...
    ("clean_scratch",  ["tools/clean_scratch.py", "--selftest"],   "bounded dry-run-first scratch TTL"),
    ("preflight",      ["tools/preflight.py", "--selftest"],       "commit diff/hygiene/fingerprint preflight"),
    ("context_budget", ["tools/context_budget.py", "--selftest"], "always-loaded context char/token budgets"),
    ...
    ("inspect_artifact", ["tools/inspect_artifact.py", "--selftest"], "bounded saved-artifact queries"),
    ("websocket_probe", ["tools/websocket_probe.py", "--selftest"], "guarded WebSocket opening handshake"),
    ...
    ("canonical_records", ["tools/canonical_records.py", "--selftest"], "typed canonical record/source-span parser"),
    ("stage_policy",    ["tools/stage_policy.py", "--selftest"], "S1/S2/S3 deterministic policy projection"),
