...
FORBIDDEN_SCOPE_PREFIXES = {
    ...
    ".claude/xunji_subagent_stop_ingress",
    "runs",
    "tools/__pycache__",
    "tools/harness/.state",
    "tools/harness/__pycache__",
